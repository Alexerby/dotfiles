...
vim.g.omni_sql_no_default_maps = 1 -- sql OmniSQL
...
-- Disable spell checking for specific programming filetypes
local prog_group = vim.api.nvim_create_augroup("ProgrammingSpellCheck", { clear = true })
vim.api.nvim_create_autocmd("FileType", {
    group = prog_group,
    pattern = { "python", "lua", "javascript", "typescript", "typescriptreact", "c", "cpp", "go", "rust" },
    callback = function()
